...
-GET /api/movies/tomatoesRanking
-GET /api/movies/[:id]

-GET /api/users/comments/:[:id]
\*Nota sobre endpoint de comments (punto extra): Faltó implementar cruzar
el id de movie con su respectivo titulo y poster. No llego por tiempo.
Este endpoint devolverá todos los comentarios (texto) hechos por el usuario proporcionado junto al id de la pelicula relacionada.
